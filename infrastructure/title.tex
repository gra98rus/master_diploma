...
\begin{center}
    ...
    {\fnt{11} ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ АВТОНОМНОЕ ОБРАЗОВАТЕЛЬНОЕ \\
        ...
        \vspace{0.3\baselineskip}
    {\fnt{11}\mbox{\textls[-18]{<<НОВОСИБИРСКИЙ НАЦИОНАЛЬНЫЙ ИССЛЕДОВАТЕЛЬСКИЙ ГОСУДАРСТВЕННЫЙ}} \\
		\vspace{-0.3\baselineskip}
...
\fnt{11}\textbf{<<К защите допущен>>} &  \\
\fnt{11}Декан ФФ НГУ                  & \fnt{11}\textbf{Научный руководитель} \\
\fnt{11}д. физ.-мат. наук             & \fnt{11}канд. техн. наук \\
